...
import languagetrainer.WordPairController;


public class GUI_LanguageTrainer extends javax.swing.JFrame {

    
    public GUI_LanguageTrainer() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Correct and wrong answer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_LanguageTrainer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_LanguageTrainer().setVisible(true);
            }
        });
    }
